...
class ScriptsManager extends AbstractContainerProvider
{
    ...
    protected function wpEnqueueScripts(): void
    {
        ...
        wp_enqueue_script(self::HANDLE, plugins_url('resources/js/wptally.js', dirname(__DIR__)), ['jquery']);
        wp_enqueue_style(self::HANDLE, plugins_url('resources/css/style.css', dirname(__DIR__)));
    }
    ...
    protected function adminEnqueueScripts(string $hook): void
    {
        ...
        wp_enqueue_style(self::HANDLE, plugins_url('resources/css/admin.css', dirname(__DIR__)));
    }
}